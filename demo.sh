...
echo "[WinBox] Đang giải nén code Python ra file tạm..."
...
cat > "$PY_FILE" << 'PYEOF_38f7a2b9c1d4e5f6'
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
